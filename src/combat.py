...
class Combat:
    ...
    def farm(self):
        ...
        while True:
            ...
            for moving_object_cords in moving_objects_cords:
                ...
                mob_name = screen.locate_center_on_screen(f'{IMAGES_PATH}/locate_minotaur.png', confidence=0.8)
                ...
                if mob_name:
                    ...
                    if attack_box:
                        ...
                        while True:
                            stack_value = screen.locate_center_on_screen(f'{IMAGES_PATH}/locked_mob.png', confidence=0.85)
                            if stack_value:
                                break
    ...
    def replenish_health(cls):
        health_bar = screen.locate_on_screen(f'{IMAGES_PATH}/health.png', confidence=0.7)
